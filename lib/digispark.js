...
var Digispark = module.exports = function Digispark(opts) {
  ...
  this.digispark = null;
  this.readInterval = (opts.extraParams.readInterval) ? opts.extraParams.readInterval.seconds() : (0.05).seconds();
...
Digispark.prototype.digitalRead = function(pin, callback) {
  ...
  every(this.readInterval, function() {
    _this.digispark.pinMode(pin, 1);
    _this.digispark.digitalRead(pin, callback);
  });
};
